...
describe('main handler', () => {
  ...
  describe('app', () => {
    it('main new user unspecified', async () => {
      ...
      const welcomeNewUser = 'Welcome to CELA Library, where you can easily access your favorite audio books.\n';
    ...
    it('main new user linked', async () => {
      ...
      const welcomeUser = 'Welcome back to your CELA Library! Remember, you can ask for help at any time.\n';
