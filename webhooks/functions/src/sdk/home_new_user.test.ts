...
describe('home_new_user handler', () => {
  ...
  describe('app', () => {
    it('on enter', async () => {
      ...
      // const message = `To fully enjoy your audiobooks and access your personal bookshelf, you will need to link your EOLE account.\nWould you like to do so now ?\n`;
      const data = await expressMocked(body, headers);

      data.prompt.firstSimple.speech.should.to.be.eq('To fully experience EOLE Library, and enjoy your favorite audiobooks via Google, you\'ll need to connect your EOLE account. To do so, answer \'yes\' when prompted and follow the instructions. I will then send a connection link, that you will find into the Google Home application. You will have to log in to your EOLE account. You\'ll only have to do this once, and you\'ll be all set to start enjoying the wonderful world of EOLE books for hours on end!\n' +
    ...
    it('no', async () => {
      ...
      // const message = `In order to read books using the EOLE Library via Google, you need to be a registered EOLE member and link your account.\nWould you like to learn more about EOLE?\n`;
    ...
    it('maybeLater', async () => {
      ...
      // const message = `Of course! you can learn more about EOLE or quit for now.\nWhat would you like to do?\n`;
    ...
    // const help = `To fully experience EOLE Library, and enjoy your favorite audiobooks via Google, you'll need to connect your EOLE account. To do so, answer 'yes' when prompted and follow the instructions. I will then send a connection link, that you will find into the Google Home application. You will have to log in to your EOLE account. You'll only have to do this once, and you'll be all set to start enjoying the wonderful world of EOLE books for hours on end!\nWould you like to link your account right now?\n`;
