...
describe('home_new_user_maybe_later handler', () => {
  ...
  describe('app', () => {
    it('on enter', async () => {
      ...
      const message = `You can ask me to link your account, or learn more about the EOLE Library. You can also exit this application, by simply saying 'stop'. What is your decision?\n`;
    ...
    // const help = `You can ask me to link your account, or to learn more about EOLE. You can also exit this skill, by simply saying 'stop'. What would you like to do?\n`;
