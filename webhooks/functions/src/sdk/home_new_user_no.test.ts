...
describe(scene + ' handler', () => {
  ...
  describe('app', () => {
    ...
    it('yes', async () => {
      ...
      // const message = `EOLE is a national non-profit organization established by Canadian public libraries to champion the fundamental right of Canadians with print disabilities to access media and reading materials in the format of their choice, including audio, braille, e-text and descriptive video. Would you like to find out more about EOLE membership, or would you prefer to exit this skill?\n`;
      // data.prompt.firstSimple.speech.should.to.be.eq(message);
    ...
    const help = `In order to use the EOLE library via your Google Home, you must be a registered member of the library and link your account. Would you like to learn more about the EOLE Library?\n`;
